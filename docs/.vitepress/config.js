  ...
  themeConfig: {
    ...
    sidebar: [
      ...
      },
      {
        text: '数据结构',
        items: [
          { text: '数组', link: '/ds/array' },
          { text: '字符串', link: '/ds/string' },
          { text: '链表', link: '/ds/list' },
          { text: '栈队', link: '/ds/stack-queue' },
          { text: '二叉树', link: '/ds/binary-tree' },
          {
            text: '二叉树遍历',
            link: '/ds/binary-tree-traverse',
          },
          {
            text: '二叉树层序遍历',
            link: '/ds/binary-tree-level-order',
          },
          { text: '二叉树 DFS', link: '/ds/binary-tree-dfs' },
          { text: '二叉搜索树', link: '/ds/bst' },
          { text: '字典树', link: '/ds/trie' },
          { text: '平衡二叉树', link: '/ds/avl' },
          { text: '哈希表', link: '/ds/hash-table' },
        ],
        collapsible: true,
        collapsed: true,
      },
      {
        ...
        items: [
          ...
          { text: '拓扑排序', link: '/algorithm/topo-sort' },
        ],
        collapsible: true,
        collapsed: true,
      },
