import{_ as i,H as a,f as n,i as l}from"./chunks/framework.DLd0CbzH.js";const g=JSON.parse('{"title":"Axios","description":"","frontmatter":{},"headers":[],"relativePath":"fe/react/fetch/axios.md","filePath":"fe/react/fetch/axios.md","lastUpdated":1720354129000}'),p={name:"fe/react/fetch/axios.md"};function h(e,s,t,k,r,E){return a(),n("div",null,[...s[0]||(s[0]=[l(`<h1 id="axios" tabindex="-1">Axios <a class="header-anchor" href="#axios" aria-label="Permalink to &quot;Axios&quot;">​</a></h1><p>调用 <code>axios</code> 函数发送请求，传入配置对象 <code>config</code>，返回 promise。</p><div class="language-js vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">axios</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(config)</span></span>
